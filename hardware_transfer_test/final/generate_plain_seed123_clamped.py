"""Generates hardware_transfer_test/final/plain_seed123_clamped/n<N>/{video.mp4,
battery_plot.png,metrics.json} for the clamped retrain of plain_seed123 -- the FINAL chosen
genome for hardware deployment (see BEAT_BASELINE_INVESTIGATION_LOG.md: chosen for clean wall
behavior over the two candidates with a higher both-beat rate). Evaluated WITH the safety
clamp active (HEBBIAN_SAFETY_CLAMP_ENABLED=True, MIN_DIST_INFLATION=1.3,
