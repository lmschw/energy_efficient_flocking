...
Usage:
    python run_agent_count_sweep.py --wind-grid 50 --output-dir ../../hebbian_results_v2_original_sweep
...
def main():
    ...
    parser.add_argument("--output-dir", default="hebbian_results_v2_original_sweep",
