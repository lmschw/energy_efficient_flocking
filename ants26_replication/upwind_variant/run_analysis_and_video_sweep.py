...
Usage:
    python run_analysis_and_video_sweep.py --sweep-dir ../../hebbian_results_v2_upwind_sweep --parallel 8
"""
import argparse
...
def main():
    ...
    parser.add_argument("--sweep-dir", default="hebbian_results_v2_upwind_sweep",
